...
export class CreateTable1687445195839 implements MigrationInterface {
    name = 'CreateTable1687445195839'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "compliments" ("id" uuid NOT NULL, "user_sender" uuid NOT NULL, "user_receiver" uuid NOT NULL, "tag_id" uuid NOT NULL, "message" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT 'now()', " tag_id" uuid, CONSTRAINT "PK_c54299c9e1656922eb0045c246e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "compliments" ADD CONSTRAINT "FK_149b837513b8a89c76212a0f8f1" FOREIGN KEY (" tag_id") REFERENCES "tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "compliments" DROP CONSTRAINT "FK_149b837513b8a89c76212a0f8f1"`);
