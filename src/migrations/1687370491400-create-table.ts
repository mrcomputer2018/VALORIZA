...
export class CreateTable1687370491400 implements MigrationInterface {
    name = 'CreateTable1687370491400'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD "pasword" character varying NOT NULL`);
